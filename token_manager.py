    ...
    def validate_token(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            response = requests.get(
                ...
                params={"institution_id": "182290", "page": 1, "page_size": 1},
                timeout=10
            )
...
def check_token_validity() -> int:
    ...
    if not token:
        ...
        print("   Set it using: $env:ACCESS_TOKEN = 'your-token-here'")
        return 1
    
    print(f"✓ BASE_URL: {base_url}")
    print(f"✓ ACCESS_TOKEN: {'*' * 20}{token[-8:] if len(token) > 8 else '***'}")
    print()
    ...
    if is_valid:
        ...
        print()
        print("Your token is working correctly and tests can run!")
        return 0
    else:
        ...
        print("2. Update the ACCESS_TOKEN environment variable")
        print("3. For CI/CD pipelines, update the secret in your pipeline settings")
        return 1
